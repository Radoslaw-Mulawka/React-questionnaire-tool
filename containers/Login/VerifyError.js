...
class VerifyError extends Component{
                                        ...
                                        <div className="form-container-login">
                                            ...
                                            <form className="form-login form-e-mail-confirmation">
                                                <div className="text-center header-div-login">
                                                    <label className="header-form-login header-e-mail-confirmation">Podany link weryfikacyjny wygasł</label>
                                                    <span className="description-e-mail-confirmation">Kliknij w przycisk poniżej aby przejść do formularzu logowania lub <Link onClick={actions.authenticationToken} to='/login-page/link-again' >wyślij mail z linkiem ponownie</Link></span>
                                                </div>
